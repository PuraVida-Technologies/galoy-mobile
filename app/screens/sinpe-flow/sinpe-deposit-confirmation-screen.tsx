...
import useSinpeConfirmation from "./hooks/useSinpeDepositConfirmation"
...
export const SinpeIBANDepositConfirmationScreen: React.FC<Props> = ({ route }) => {
      ...
      <ScrollView style={styles.scrollViewContainer}>
        <View style={styles.snipeInfoCard}>
          <View style={styles.snipeInfoField}>
            <Text style={styles.snipeInfoFieldTitle}>{LL.common.fromBankAccount()}</Text>
          ...
          <SinpeInfoFieldPVAccount
            sinpeInfoFieldTitle={LL.common.to()}
