...
export type AuditedAccountEmail = {
  readonly __typename: 'AuditedAccountEmail';
  readonly email: Scalars['String']['output'];
  readonly verified: Scalars['Boolean']['output'];
};

export type AuditedAccountOwner = {
...
export type AuditedAccountResponse = {
  readonly __typename: 'AuditedAccountResponse';
  readonly createdAt: Scalars['DateTime']['output'];
  readonly id: Scalars['String']['output'];
  readonly level: UserAccountLevel;
  readonly owner: AuditedAccountOwner;
...
export type BankAccountVerification = {
  readonly __typename: 'BankAccountVerification';
  ...
  readonly errorCode?: Maybe<Scalars['Float']['output']>;
...
export type CurrencyExchangeInstanceTransaction = {
  ...
  readonly destinationType: TransactionDestinationTypes;
  readonly fee: Scalars['BigDecimal']['output'];
  readonly id: Scalars['String']['output'];
  readonly metadata?: Maybe<TransactionMetadata>;
...
export type CurrencyExchangeTransactionGraphqlResponse = {
  ...
  readonly amount: Scalars['BigDecimal']['output'];
  readonly baseAmount: Scalars['BigDecimal']['output'];
  readonly baseAmountCurrency: Currencies;
  readonly createdAt: Scalars['DateTime']['output'];
  readonly currency: BankAccountCurrencies;
  readonly galoyUserId: Scalars['String']['output'];
  readonly id: Scalars['String']['output'];
...
export type DepositContractAmounts = {
  ...
  readonly bankAccountDebit: ResolvedCurrencyExchangeAmount;
  ...
  readonly walletCredit: ResolvedCurrencyExchangeAmount;
};
...
export type ExecuteWithdrawalContract = {
  readonly token: Scalars['String']['input'];
};
...
export type GetWithdrawalLimitsInputDto = {
  /** currency to return amounts in */
  readonly currency: BankAccountCurrencies;
  /** payment system to return amounts for */
  readonly paymentSystemType?: PaymentSystem;
...
export type GrantPermissionInput = {
  readonly galoyUserId: Scalars['String']['input'];
  readonly permission: Permission;
};

export type GrantPermissionResponse = {
  readonly __typename: 'GrantPermissionResponse';
  readonly galoyUserId: Scalars['String']['output'];
  readonly name: Scalars['String']['output'];
};
...
export type Mutation = {
   ...
   */
  readonly executeWithdrawalContract?: Maybe<WithdrawalContract>;
  readonly feedbackSubmit: SuccessPayload;
  readonly grantUserPermission: GrantPermissionResponse;
  /**
  ...
  readonly revokeUserPermission: RevokePermissionResponse;
...
export type MutationExecuteWithdrawalContractArgs = {
...
/** Payment system that is by us be it IBAN or MOVIL */
...
export type PublicKycWallet = {
  readonly __typename: 'PublicKycWallet';
  readonly currency: Currencies;
  readonly id: Scalars['String']['output'];
};
...
export type Query = {
  ...
  readonly externalDailyLimit: Scalars['BigDecimal']['output'];
  ...
  /** returns the values of the current withdrawal limits for the user */
  readonly getWithdrawalLimits: ReadonlyArray<WithdrawalLimits>;
  ...
  readonly myBankAccountDetails: BankAccountVerification;
  ...
  readonly verifyIbanAccount: BankAccountVerification;
};
...
export type QueryFindAuditedAccountArgs = {
...
export type QueryGetWithdrawalContractArgs = {
  input: GetWithDrawalContractInput;
};


export type QueryGetWithdrawalLimitsArgs = {
...
export type QueryMyBankAccountDetailsArgs = {
  bankAccountId: Scalars['String']['input'];
};
...
export type QueryVerifyIbanAccountArgs = {
...
export type ResolvedCurrencyExchangeAmount = {
  ...
  /** The same amount but represented in the input source currency */
  readonly amountInSourceCurrency: Scalars['BigDecimal']['output'];
  ...
  readonly currency: Currencies;
  /** The time at which the BTC currency exchange rate was evaluated */
  readonly resolvedAt: Scalars['String']['output'];
  /** currency of the input source amount */
  readonly sourceCurrency: Currencies;
};

export type RevokePermissionResponse = {
  readonly __typename: 'RevokePermissionResponse';
...
export type SettingsResponse = {
  readonly __typename: 'SettingsResponse';
...
/** Allowed destination types for transactions */
export const TransactionDestinationTypes = {
  ExternalAccount: 'EXTERNAL_ACCOUNT',
  GaloyWallet: 'GALOY_WALLET'
} as const;

export type TransactionDestinationTypes = typeof TransactionDestinationTypes[keyof typeof TransactionDestinationTypes];
/** An edge in a connection. */
...
export type UserAccountLevel = typeof UserAccountLevel[keyof typeof UserAccountLevel];
...
export type WithdrawalContract = {
  ...
  /** id that represents the whole withdrawal operation */
  readonly id: Scalars['String']['output'];
  readonly limits: ReadonlyArray<WithdrawalLimits>;
  /** Users galoy wallet that was used to withdraw  */
  readonly sourceWallet: PublicKycWallet;
  /**
   * Token that represents a snapshot in time:
...
export type WithdrawalContractAmounts = {
  readonly __typename: 'WithdrawalContractAmounts';
  /** the amount that will be credited to the user bank account, the currency is the same as the target currency */
...
export type WithdrawalContractTokenDetails = {
  readonly __typename: 'WithdrawalContractTokenDetails';
  readonly body: Scalars['String']['output'];
  readonly createdAt: Scalars['String']['output'];
  readonly executedAt?: Maybe<Scalars['String']['output']>;
  readonly expiresAt: Scalars['String']['output'];
...
export type VerifyIbanAccountQueryVariables = Exact<{
  iban: Scalars['String']['input'];
}>;


export type VerifyIbanAccountQuery = { readonly __typename: 'Query', readonly verifyIbanAccount: { readonly __typename: 'BankAccountVerification', readonly success: boolean, readonly iban?: string | null, readonly bankName?: string | null, readonly alias?: string | null, readonly currencyCode: string, readonly errorCode?: number | null, readonly message?: string | null } };
...
export type CaptchaRequestAuthCodeForPhoneInputMutationVariables = Exact<{
  input: CaptchaRequestAuthCodeInput;
}>;
...
export type ReceiveWrapperScreenQuery = { readonly __typename: 'Query', readonly me?: { readonly __typename: 'User', readonly id: string, readonly defaultAccount: { readonly __typename: 'ConsumerAccount', readonly id: string, readonly defaultWallet: { readonly __typename: 'PublicWallet', readonly walletCurrency: WalletCurrency } } } | null };

export type LnNoAmountInvoiceCreateForPaymentRequestMutationVariables = Exact<{
  input: LnNoAmountInvoiceCreateInput;
}>;


export type LnNoAmountInvoiceCreateForPaymentRequestMutation = { readonly __typename: 'Mutation', readonly lnNoAmountInvoiceCreate: { readonly __typename: 'LnNoAmountInvoicePayload', readonly errors: ReadonlyArray<{ readonly __typename: 'GraphQLApplicationError', readonly message: string }>, readonly invoice?: { readonly __typename: 'LnNoAmountInvoice', readonly paymentHash: string, readonly paymentRequest: string, readonly paymentSecret: string } | null } };

export type LnInvoiceCreateForPaymentRequestMutationVariables = Exact<{
  input: LnInvoiceCreateInput;
}>;


export type LnInvoiceCreateForPaymentRequestMutation = { readonly __typename: 'Mutation', readonly lnInvoiceCreate: { readonly __typename: 'LnInvoicePayload', readonly errors: ReadonlyArray<{ readonly __typename: 'GraphQLApplicationError', readonly message: string }>, readonly invoice?: { readonly __typename: 'LnInvoice', readonly paymentHash: string, readonly paymentRequest: string, readonly paymentSecret: string, readonly satoshis: number } | null } };
...
export type LnUsdInvoiceCreateForPaymentRequestMutationVariables = Exact<{
  input: LnUsdInvoiceCreateInput;
}>;


export type LnUsdInvoiceCreateForPaymentRequestMutation = { readonly __typename: 'Mutation', readonly lnUsdInvoiceCreate: { readonly __typename: 'LnInvoicePayload', readonly errors: ReadonlyArray<{ readonly __typename: 'GraphQLApplicationError', readonly message: string }>, readonly invoice?: { readonly __typename: 'LnInvoice', readonly paymentHash: string, readonly paymentRequest: string, readonly paymentSecret: string, readonly satoshis: number } | null } };
...
export type UserTotpDeleteForAccountScreenMutationVariables = Exact<{ [key: string]: never; }>;


export type UserTotpDeleteForAccountScreenMutation = { readonly __typename: 'Mutation', readonly userTotpDelete: { readonly __typename: 'UserTotpDeletePayload', readonly errors: ReadonlyArray<{ readonly __typename: 'GraphQLApplicationError', readonly message: string }>, readonly me?: { readonly __typename: 'User', readonly id: string, readonly phone?: string | null, readonly totpEnabled: boolean, readonly email?: { readonly __typename: 'Email', readonly address?: string | null, readonly verified?: boolean | null } | null } | null } };
...
export type ExecuteDepositContractMutationVariables = Exact<{
  input: ExecuteContractInput;
}>;


export type ExecuteDepositContractMutation = { readonly __typename: 'Mutation', readonly executeDepositContract: { readonly __typename: 'DepositContractNoTokenDetails', readonly id: string } };
...
export const VerifyIbanAccountDocument = gql`
...
/**
 * __useVerifyIbanAccountQuery__
 *
 * To run a query within a React component, call `useVerifyIbanAccountQuery` and pass it any options that fit your needs.
 * When your component renders, `useVerifyIbanAccountQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useVerifyIbanAccountQuery({
 *   variables: {
 *      iban: // value for 'iban'
 *   },
 * });
 */
export function useVerifyIbanAccountQuery(baseOptions: Apollo.QueryHookOptions<VerifyIbanAccountQuery, VerifyIbanAccountQueryVariables> & ({ variables: VerifyIbanAccountQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<VerifyIbanAccountQuery, VerifyIbanAccountQueryVariables>(VerifyIbanAccountDocument, options);
      }
export function useVerifyIbanAccountLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<VerifyIbanAccountQuery, VerifyIbanAccountQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<VerifyIbanAccountQuery, VerifyIbanAccountQueryVariables>(VerifyIbanAccountDocument, options);
        }
export function useVerifyIbanAccountSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<VerifyIbanAccountQuery, VerifyIbanAccountQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<VerifyIbanAccountQuery, VerifyIbanAccountQueryVariables>(VerifyIbanAccountDocument, options);
        }
export type VerifyIbanAccountQueryHookResult = ReturnType<typeof useVerifyIbanAccountQuery>;
export type VerifyIbanAccountLazyQueryHookResult = ReturnType<typeof useVerifyIbanAccountLazyQuery>;
export type VerifyIbanAccountSuspenseQueryHookResult = ReturnType<typeof useVerifyIbanAccountSuspenseQuery>;
export type VerifyIbanAccountQueryResult = Apollo.QueryResult<VerifyIbanAccountQuery, VerifyIbanAccountQueryVariables>;
...
export const CaptchaRequestAuthCodeForPhoneInputDocument = gql`
  ...
  captchaRequestAuthCode(input: $input) {
    ...
    `;
export type CaptchaRequestAuthCodeForPhoneInputMutationFn = Apollo.MutationFunction<CaptchaRequestAuthCodeForPhoneInputMutation, CaptchaRequestAuthCodeForPhoneInputMutationVariables>;

/**
 * __useCaptchaRequestAuthCodeForPhoneInputMutation__
 *
 * To run a mutation, you first call `useCaptchaRequestAuthCodeForPhoneInputMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCaptchaRequestAuthCodeForPhoneInputMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [captchaRequestAuthCodeForPhoneInputMutation, { data, loading, error }] = useCaptchaRequestAuthCodeForPhoneInputMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCaptchaRequestAuthCodeForPhoneInputMutation(baseOptions?: Apollo.MutationHookOptions<CaptchaRequestAuthCodeForPhoneInputMutation, CaptchaRequestAuthCodeForPhoneInputMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CaptchaRequestAuthCodeForPhoneInputMutation, CaptchaRequestAuthCodeForPhoneInputMutationVariables>(CaptchaRequestAuthCodeForPhoneInputDocument, options);
      }
...
export function useReceiveBtcSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<ReceiveBtcQuery, ReceiveBtcQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<ReceiveBtcQuery, ReceiveBtcQueryVariables>(ReceiveBtcDocument, options);
        }
...
export type ReceiveBtcSuspenseQueryHookResult = ReturnType<typeof useReceiveBtcSuspenseQuery>;
...
export function useReceiveUsdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<ReceiveUsdQuery, ReceiveUsdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<ReceiveUsdQuery, ReceiveUsdQueryVariables>(ReceiveUsdDocument, options);
        }
...
export type ReceiveUsdSuspenseQueryHookResult = ReturnType<typeof useReceiveUsdSuspenseQuery>;
...
export function useReceiveWrapperScreenSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<ReceiveWrapperScreenQuery, ReceiveWrapperScreenQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<ReceiveWrapperScreenQuery, ReceiveWrapperScreenQueryVariables>(ReceiveWrapperScreenDocument, options);
        }
...
export type ReceiveWrapperScreenSuspenseQueryHookResult = ReturnType<typeof useReceiveWrapperScreenSuspenseQuery>;
...
export const LnNoAmountInvoiceCreateForPaymentRequestDocument = gql`
    mutation lnNoAmountInvoiceCreateForPaymentRequest($input: LnNoAmountInvoiceCreateInput!) {
  lnNoAmountInvoiceCreate(input: $input) {
    ...
    `;
export type LnNoAmountInvoiceCreateForPaymentRequestMutationFn = Apollo.MutationFunction<LnNoAmountInvoiceCreateForPaymentRequestMutation, LnNoAmountInvoiceCreateForPaymentRequestMutationVariables>;

/**
 * __useLnNoAmountInvoiceCreateForPaymentRequestMutation__
 *
 * To run a mutation, you first call `useLnNoAmountInvoiceCreateForPaymentRequestMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useLnNoAmountInvoiceCreateForPaymentRequestMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [lnNoAmountInvoiceCreateForPaymentRequestMutation, { data, loading, error }] = useLnNoAmountInvoiceCreateForPaymentRequestMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useLnNoAmountInvoiceCreateForPaymentRequestMutation(baseOptions?: Apollo.MutationHookOptions<LnNoAmountInvoiceCreateForPaymentRequestMutation, LnNoAmountInvoiceCreateForPaymentRequestMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<LnNoAmountInvoiceCreateForPaymentRequestMutation, LnNoAmountInvoiceCreateForPaymentRequestMutationVariables>(LnNoAmountInvoiceCreateForPaymentRequestDocument, options);
      }
export type LnNoAmountInvoiceCreateForPaymentRequestMutationHookResult = ReturnType<typeof useLnNoAmountInvoiceCreateForPaymentRequestMutation>;
export type LnNoAmountInvoiceCreateForPaymentRequestMutationResult = Apollo.MutationResult<LnNoAmountInvoiceCreateForPaymentRequestMutation>;
export type LnNoAmountInvoiceCreateForPaymentRequestMutationOptions = Apollo.BaseMutationOptions<LnNoAmountInvoiceCreateForPaymentRequestMutation, LnNoAmountInvoiceCreateForPaymentRequestMutationVariables>;
export const LnInvoiceCreateForPaymentRequestDocument = gql`
  ...
  lnInvoiceCreate(input: $input) {
    ...
    `;
export type LnInvoiceCreateForPaymentRequestMutationFn = Apollo.MutationFunction<LnInvoiceCreateForPaymentRequestMutation, LnInvoiceCreateForPaymentRequestMutationVariables>;

/**
 * __useLnInvoiceCreateForPaymentRequestMutation__
 *
 * To run a mutation, you first call `useLnInvoiceCreateForPaymentRequestMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useLnInvoiceCreateForPaymentRequestMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [lnInvoiceCreateForPaymentRequestMutation, { data, loading, error }] = useLnInvoiceCreateForPaymentRequestMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useLnInvoiceCreateForPaymentRequestMutation(baseOptions?: Apollo.MutationHookOptions<LnInvoiceCreateForPaymentRequestMutation, LnInvoiceCreateForPaymentRequestMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<LnInvoiceCreateForPaymentRequestMutation, LnInvoiceCreateForPaymentRequestMutationVariables>(LnInvoiceCreateForPaymentRequestDocument, options);
      }
export type LnInvoiceCreateForPaymentRequestMutationHookResult = ReturnType<typeof useLnInvoiceCreateForPaymentRequestMutation>;
export type LnInvoiceCreateForPaymentRequestMutationResult = Apollo.MutationResult<LnInvoiceCreateForPaymentRequestMutation>;
export type LnInvoiceCreateForPaymentRequestMutationOptions = Apollo.BaseMutationOptions<LnInvoiceCreateForPaymentRequestMutation, LnInvoiceCreateForPaymentRequestMutationVariables>;
...
export const LnUsdInvoiceCreateForPaymentRequestDocument = gql`
  ...
  lnUsdInvoiceCreate(input: $input) {
    ...
    `;
export type LnUsdInvoiceCreateForPaymentRequestMutationFn = Apollo.MutationFunction<LnUsdInvoiceCreateForPaymentRequestMutation, LnUsdInvoiceCreateForPaymentRequestMutationVariables>;

/**
 * __useLnUsdInvoiceCreateForPaymentRequestMutation__
 *
 * To run a mutation, you first call `useLnUsdInvoiceCreateForPaymentRequestMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useLnUsdInvoiceCreateForPaymentRequestMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [lnUsdInvoiceCreateForPaymentRequestMutation, { data, loading, error }] = useLnUsdInvoiceCreateForPaymentRequestMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useLnUsdInvoiceCreateForPaymentRequestMutation(baseOptions?: Apollo.MutationHookOptions<LnUsdInvoiceCreateForPaymentRequestMutation, LnUsdInvoiceCreateForPaymentRequestMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<LnUsdInvoiceCreateForPaymentRequestMutation, LnUsdInvoiceCreateForPaymentRequestMutationVariables>(LnUsdInvoiceCreateForPaymentRequestDocument, options);
      }
export type LnUsdInvoiceCreateForPaymentRequestMutationHookResult = ReturnType<typeof useLnUsdInvoiceCreateForPaymentRequestMutation>;
export type LnUsdInvoiceCreateForPaymentRequestMutationResult = Apollo.MutationResult<LnUsdInvoiceCreateForPaymentRequestMutation>;
export type LnUsdInvoiceCreateForPaymentRequestMutationOptions = Apollo.BaseMutationOptions<LnUsdInvoiceCreateForPaymentRequestMutation, LnUsdInvoiceCreateForPaymentRequestMutationVariables>;
...
export function useAccountScreenSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AccountScreenQuery, AccountScreenQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AccountScreenQuery, AccountScreenQueryVariables>(AccountScreenDocument, options);
        }
...
export type AccountScreenSuspenseQueryHookResult = ReturnType<typeof useAccountScreenSuspenseQuery>;
...
export const UserTotpDeleteForAccountScreenDocument = gql`
  ...
  userTotpDelete {
    ...
    `;
export type UserTotpDeleteForAccountScreenMutationFn = Apollo.MutationFunction<UserTotpDeleteForAccountScreenMutation, UserTotpDeleteForAccountScreenMutationVariables>;

/**
 * __useUserTotpDeleteForAccountScreenMutation__
 *
 * To run a mutation, you first call `useUserTotpDeleteForAccountScreenMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUserTotpDeleteForAccountScreenMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [userTotpDeleteForAccountScreenMutation, { data, loading, error }] = useUserTotpDeleteForAccountScreenMutation({
 *   variables: {
 *   },
 * });
 */
export function useUserTotpDeleteForAccountScreenMutation(baseOptions?: Apollo.MutationHookOptions<UserTotpDeleteForAccountScreenMutation, UserTotpDeleteForAccountScreenMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UserTotpDeleteForAccountScreenMutation, UserTotpDeleteForAccountScreenMutationVariables>(UserTotpDeleteForAccountScreenDocument, options);
      }
export type UserTotpDeleteForAccountScreenMutationHookResult = ReturnType<typeof useUserTotpDeleteForAccountScreenMutation>;
export type UserTotpDeleteForAccountScreenMutationResult = Apollo.MutationResult<UserTotpDeleteForAccountScreenMutation>;
export type UserTotpDeleteForAccountScreenMutationOptions = Apollo.BaseMutationOptions<UserTotpDeleteForAccountScreenMutation, UserTotpDeleteForAccountScreenMutationVariables>;
...
export const ExecuteDepositContractDocument = gql`
  ...
  executeDepositContract(input: $input) {
    ...
    `;
export type ExecuteDepositContractMutationFn = Apollo.MutationFunction<ExecuteDepositContractMutation, ExecuteDepositContractMutationVariables>;

/**
 * __useExecuteDepositContractMutation__
 *
 * To run a mutation, you first call `useExecuteDepositContractMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useExecuteDepositContractMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [executeDepositContractMutation, { data, loading, error }] = useExecuteDepositContractMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useExecuteDepositContractMutation(baseOptions?: Apollo.MutationHookOptions<ExecuteDepositContractMutation, ExecuteDepositContractMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ExecuteDepositContractMutation, ExecuteDepositContractMutationVariables>(ExecuteDepositContractDocument, options);
      }
export type ExecuteDepositContractMutationHookResult = ReturnType<typeof useExecuteDepositContractMutation>;
export type ExecuteDepositContractMutationResult = Apollo.MutationResult<ExecuteDepositContractMutation>;
export type ExecuteDepositContractMutationOptions = Apollo.BaseMutationOptions<ExecuteDepositContractMutation, ExecuteDepositContractMutationVariables>;
...
export const ExecuteWithdrawalContractDocument = gql`
  ...
  executeWithdrawalContract(input: $input) {
    ...
    `;
export type ExecuteWithdrawalContractMutationFn = Apollo.MutationFunction<ExecuteWithdrawalContractMutation, ExecuteWithdrawalContractMutationVariables>;

/**
 * __useExecuteWithdrawalContractMutation__
 *
 * To run a mutation, you first call `useExecuteWithdrawalContractMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useExecuteWithdrawalContractMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [executeWithdrawalContractMutation, { data, loading, error }] = useExecuteWithdrawalContractMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useExecuteWithdrawalContractMutation(baseOptions?: Apollo.MutationHookOptions<ExecuteWithdrawalContractMutation, ExecuteWithdrawalContractMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ExecuteWithdrawalContractMutation, ExecuteWithdrawalContractMutationVariables>(ExecuteWithdrawalContractDocument, options);
      }
export type ExecuteWithdrawalContractMutationHookResult = ReturnType<typeof useExecuteWithdrawalContractMutation>;
export type ExecuteWithdrawalContractMutationResult = Apollo.MutationResult<ExecuteWithdrawalContractMutation>;
export type ExecuteWithdrawalContractMutationOptions = Apollo.BaseMutationOptions<ExecuteWithdrawalContractMutation, ExecuteWithdrawalContractMutationVariables>;
export const GetWithdrawalContractDocument = gql`
...
/**
 * __useGetWithdrawalContractQuery__
 *
 * To run a query within a React component, call `useGetWithdrawalContractQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetWithdrawalContractQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetWithdrawalContractQuery({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useGetWithdrawalContractQuery(baseOptions: Apollo.QueryHookOptions<GetWithdrawalContractQuery, GetWithdrawalContractQueryVariables> & ({ variables: GetWithdrawalContractQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetWithdrawalContractQuery, GetWithdrawalContractQueryVariables>(GetWithdrawalContractDocument, options);
      }
export function useGetWithdrawalContractLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetWithdrawalContractQuery, GetWithdrawalContractQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetWithdrawalContractQuery, GetWithdrawalContractQueryVariables>(GetWithdrawalContractDocument, options);
        }
export function useGetWithdrawalContractSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetWithdrawalContractQuery, GetWithdrawalContractQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetWithdrawalContractQuery, GetWithdrawalContractQueryVariables>(GetWithdrawalContractDocument, options);
        }
export type GetWithdrawalContractQueryHookResult = ReturnType<typeof useGetWithdrawalContractQuery>;
...
export type ResolversTypes = {
  ...
  AuditedAccountEmail: ResolverTypeWrapper<AuditedAccountEmail>;
  AuditedAccountOwner: ResolverTypeWrapper<AuditedAccountOwner>;
  AuditedAccountResponse: ResolverTypeWrapper<AuditedAccountResponse>;
  ...
  BankAccountVerification: ResolverTypeWrapper<BankAccountVerification>;
  ...
  ExecuteContractInput: ExecuteContractInput;
  ExecuteWithdrawalContract: ExecuteWithdrawalContract;
  ...
  GetWithdrawalLimitsInputDTO: GetWithdrawalLimitsInputDto;
  Globals: ResolverTypeWrapper<Globals>;
  GrantPermissionInput: GrantPermissionInput;
  GrantPermissionResponse: ResolverTypeWrapper<GrantPermissionResponse>;
  ...
  PublicKycWallet: ResolverTypeWrapper<PublicKycWallet>;
  ...
  ResolvedCurrencyExchangeAmount: ResolverTypeWrapper<ResolvedCurrencyExchangeAmount>;
  RevokePermissionResponse: ResolverTypeWrapper<RevokePermissionResponse>;
  ...
  SettingsResponse: ResolverTypeWrapper<SettingsResponse>;
...
export type ResolversParentTypes = {
  ...
  AuditedAccountEmail: AuditedAccountEmail;
  AuditedAccountOwner: AuditedAccountOwner;
  AuditedAccountResponse: AuditedAccountResponse;
  ...
  PublicKycWallet: PublicKycWallet;
  ...
  Region: Region;
  ResolvedCurrencyExchangeAmount: ResolvedCurrencyExchangeAmount;
...
export type AuditedAccountEmailResolvers<ContextType = any, ParentType extends ResolversParentTypes['AuditedAccountEmail'] = ResolversParentTypes['AuditedAccountEmail']> = {
...
export type AuditedAccountResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['AuditedAccountResponse'] = ResolversParentTypes['AuditedAccountResponse']> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  level?: Resolver<ResolversTypes['UserAccountLevel'], ParentType, ContextType>;
  owner?: Resolver<ResolversTypes['AuditedAccountOwner'], ParentType, ContextType>;
...
export type BankAccountVerificationResolvers<ContextType = any, ParentType extends ResolversParentTypes['BankAccountVerification'] = ResolversParentTypes['BankAccountVerification']> = {
...
export type CurrencyExchangeInstanceTransactionResolvers<ContextType = any, ParentType extends ResolversParentTypes['CurrencyExchangeInstanceTransaction'] = ResolversParentTypes['CurrencyExchangeInstanceTransaction']> = {
  ...
  destinationType?: Resolver<ResolversTypes['TransactionDestinationTypes'], ParentType, ContextType>;
  fee?: Resolver<ResolversTypes['BigDecimal'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  metadata?: Resolver<Maybe<ResolversTypes['TransactionMetadata']>, ParentType, ContextType>;
...
export type CurrencyExchangeTransactionGraphqlResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['CurrencyExchangeTransactionGraphqlResponse'] = ResolversParentTypes['CurrencyExchangeTransactionGraphqlResponse']> = {
  amount?: Resolver<ResolversTypes['BigDecimal'], ParentType, ContextType>;
  baseAmount?: Resolver<ResolversTypes['BigDecimal'], ParentType, ContextType>;
  baseAmountCurrency?: Resolver<ResolversTypes['Currencies'], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  currency?: Resolver<ResolversTypes['BankAccountCurrencies'], ParentType, ContextType>;
  galoyUserId?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type DepositContractAmountsResolvers<ContextType = any, ParentType extends ResolversParentTypes['DepositContractAmounts'] = ResolversParentTypes['DepositContractAmounts']> = {
  bankAccountDebit?: Resolver<ResolversTypes['ResolvedCurrencyExchangeAmount'], ParentType, ContextType>;
  ...
  walletCredit?: Resolver<ResolversTypes['ResolvedCurrencyExchangeAmount'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type GrantPermissionResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['GrantPermissionResponse'] = ResolversParentTypes['GrantPermissionResponse']> = {
  galoyUserId?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  revokeUserPermission?: Resolver<ResolversTypes['RevokePermissionResponse'], ParentType, ContextType, RequireFields<MutationRevokeUserPermissionArgs, 'input'>>;
...
export type PublicKycWalletResolvers<ContextType = any, ParentType extends ResolversParentTypes['PublicKycWallet'] = ResolversParentTypes['PublicKycWallet']> = {
  currency?: Resolver<ResolversTypes['Currencies'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  externalDailyLimit?: Resolver<ResolversTypes['BigDecimal'], ParentType, ContextType>;
  ...
  myBankAccountDetails?: Resolver<ResolversTypes['BankAccountVerification'], ParentType, ContextType, RequireFields<QueryMyBankAccountDetailsArgs, 'bankAccountId'>>;
  ...
  verifyIbanAccount?: Resolver<ResolversTypes['BankAccountVerification'], ParentType, ContextType, RequireFields<QueryVerifyIbanAccountArgs, 'iban'>>;
};
...
export type ResolvedCurrencyExchangeAmountResolvers<ContextType = any, ParentType extends ResolversParentTypes['ResolvedCurrencyExchangeAmount'] = ResolversParentTypes['ResolvedCurrencyExchangeAmount']> = {
  amount?: Resolver<ResolversTypes['BigDecimal'], ParentType, ContextType>;
  amountInSats?: Resolver<ResolversTypes['BigDecimal'], ParentType, ContextType>;
  amountInSourceCurrency?: Resolver<ResolversTypes['BigDecimal'], ParentType, ContextType>;
  btcSatPrice?: Resolver<ResolversTypes['BigDecimal'], ParentType, ContextType>;
  currency?: Resolver<ResolversTypes['Currencies'], ParentType, ContextType>;
  resolvedAt?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  sourceCurrency?: Resolver<ResolversTypes['Currencies'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type RevokePermissionResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['RevokePermissionResponse'] = ResolversParentTypes['RevokePermissionResponse']> = {
...
export type SettingsResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['SettingsResponse'] = ResolversParentTypes['SettingsResponse']> = {
...
export type WithdrawalContractResolvers<ContextType = any, ParentType extends ResolversParentTypes['WithdrawalContract'] = ResolversParentTypes['WithdrawalContract']> = {
  amounts?: Resolver<ResolversTypes['WithdrawalContractAmounts'], ParentType, ContextType>;
  bankAccount?: Resolver<ResolversTypes['BankAccount'], ParentType, ContextType>;
  exchangeWallet?: Resolver<ResolversTypes['PublicKycWallet'], ParentType, ContextType>;
  feeExplanation?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  limits?: Resolver<ReadonlyArray<ResolversTypes['WithdrawalLimits']>, ParentType, ContextType>;
  sourceWallet?: Resolver<ResolversTypes['PublicKycWallet'], ParentType, ContextType>;
...
export type WithdrawalContractAmountsResolvers<ContextType = any, ParentType extends ResolversParentTypes['WithdrawalContractAmounts'] = ResolversParentTypes['WithdrawalContractAmounts']> = {
...
export type WithdrawalContractTokenDetailsResolvers<ContextType = any, ParentType extends ResolversParentTypes['WithdrawalContractTokenDetails'] = ResolversParentTypes['WithdrawalContractTokenDetails']> = {
  body?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  executedAt?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  expiresAt?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type Resolvers<ContextType = any> = {
  ...
  AuditedAccountEmail?: AuditedAccountEmailResolvers<ContextType>;
  AuditedAccountOwner?: AuditedAccountOwnerResolvers<ContextType>;
  AuditedAccountResponse?: AuditedAccountResponseResolvers<ContextType>;
  ...
  BankAccountVerification?: BankAccountVerificationResolvers<ContextType>;
  ...
  PublicKycWallet?: PublicKycWalletResolvers<ContextType>;
  ...
  ResolvedCurrencyExchangeAmount?: ResolvedCurrencyExchangeAmountResolvers<ContextType>;
  RevokePermissionResponse?: RevokePermissionResponseResolvers<ContextType>;
  SafeInt?: GraphQLScalarType;
  SatAmount?: GraphQLScalarType;
  SatAmountPayload?: SatAmountPayloadResolvers<ContextType>;
  Seconds?: GraphQLScalarType;
  SettingsResponse?: SettingsResponseResolvers<ContextType>;
